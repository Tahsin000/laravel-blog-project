<div id="" class="container section-marginTop text-center">
        ...
        @foreach ($courseData as $courseData)
            <div class="col-md-4 thumbnail-container">
                ...
                <div class="thumbnail-middle">
                    ...
                    <h1 class="thumbnail-subtitle">{{$courseData->course_des}}
                    <h1 class="thumbnail-subtitle">{{$courseData->course_totalclass}}
                        প্রদান
                        করি </h1>
