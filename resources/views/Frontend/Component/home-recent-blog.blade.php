<div id="BlogId" class="container section-marginTop text-center">
        ...
        @foreach ($blogData as $blogData)
            <div class="col-md-4  p-2 ">
                <div class="card">
                    ...
                    <div class="w-100 p-4">
                        <h5 class="blog-card-title text-justify  mt-2">{{$blogData->title}}</h5>
                        <h6 class="blog-card-subtitle text-justify p-0 ">{{$blogData->description}}</h6>
